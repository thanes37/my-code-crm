...
public class ReportPointSumFragment extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_report_point_sum, container, false);
		
		progressBar = (ProgressBar) rootView.findViewById(R.id.prgbReportPoint);
		progressBar.setVisibility(View.INVISIBLE);
		layout = (LinearLayout)  rootView.findViewById(R.id.graphPointSumup);
		if (ConnectServer.isOnline(context)){
        	new GetReportPointTask().execute();
        } else {
        	// XXX
//        	Toast.makeText(
//					context, 
...
//					Toast.LENGTH_LONG).show();
	...
	private class GetReportPointTask extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... uid) {
        	...
        	dateStatList = connect.getPointSumupReport(dayBack);
	...
	private void drawGraph(){
		...
		GraphViewSeries graphSeries = new GraphViewSeries(
				context.getResources().getString(R.string.report_heading_point_sumup),
				style,
				graphViewData);
