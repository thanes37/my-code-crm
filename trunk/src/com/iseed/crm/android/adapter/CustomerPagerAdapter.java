...
public class CustomerPagerAdapter extends FragmentPagerAdapter {
	...
	public CustomerPagerAdapter(Context ctx, FragmentManager fm) {		
		super(fm);
		context = ctx;
	}
	...
	public CharSequence getPageTitle(int position) {
		...
		switch (position) {
		case 0:
			return context.getString(R.string.title_customer_section1).toUpperCase(l);
		case 1:
			return context.getString(R.string.title_customer_section2).toUpperCase(l);
		case 2:
			return context.getString(R.string.title_customer_section3).toUpperCase(l);
		}
		return null;
	}
}